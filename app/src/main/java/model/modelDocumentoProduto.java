...
public class modelDocumentoProduto {
    ...
    public double getTotalprodutocdesc() {
        return totalprodutocdesc;
    }

    public void setTotalprodutocdesc(double totalprodutocdesc) {
        this.totalprodutocdesc = totalprodutocdesc;
    }
